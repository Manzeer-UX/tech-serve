...
export interface PhilosophySectionCardProps {
  block: PhilosophySectionBlockType;
  index: number;
}

export function PhilosophySectionCard({
  block,
  index,
}: Readonly<PhilosophySectionCardProps>) {
  return (
    <div className="rounded-[2rem] border border-[var(--color-border-strong)] bg-[linear-gradient(180deg,rgba(255,255,255,0.92),rgba(248,243,255,0.78))] px-5 py-5 shadow-[var(--shadow-card)] md:px-6 md:py-6">
